...
def setup_3d_recovery(dirname):
    ...
    rho_recoverer = Recoverer(rho_DG0, rho_CG1, VDG=VDG1, periodicity='y', boundary_method=Boundary_Method.dynamics_rho)
    theta_recoverer = Recoverer(theta_Vt, theta_CG1, VDG=VDG1, periodicity='y', boundary_method=Boundary_Method.dynamics_theta)
    v_recoverer = Recoverer(v_Vu, v_CG1, VDG=VuDG1, periodicity='y', boundary_method=Boundary_Method.dynamics_u)
    rho_Vt_recoverer = Recoverer(rho_DG0, rho_Vt, VDG=Vt_brok, periodicity='y', boundary_method=Boundary_Method.physics)
